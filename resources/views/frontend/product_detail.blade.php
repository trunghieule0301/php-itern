        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <embed class="card-img img-fluid" type="{{$product->product_image_mime}}" src="data:{{$product->product_image_mime}};base64,{{base64_encode($product->product_image)}}" height="200" />
                    </div>
                    <div class="row">
                        @if($check == 1)
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <a href="#">
                                                <embed class="card-img img-fluid" type="{{$value->image_mime}}" src="data:{{$value->image_mime}};base64,{{base64_encode($value->image_data)}}" height="200" />
                                            </a>
                                        </div>
                                        @endif
                                        @endforeach
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="h3 py-2">{{number_format($product->product_price).'Vnd'}}</p>
                            <!--
                            <p class="py-2">
